...
public class ASEUtil {
     ...
     *6.返回字符串
     */
    public static String aesEncode(String content,String solt){
        try{
            ...
            //解决办法：
            //在项目的Buildpath中先移除JRESystemLibrary，再添加库JRESystemLibrary，重新编译后就一切正常了。
     ...
     *3.将加密内容解密
     */
    public static String aesDecode(String content,String solt){
        try{
            //1.构造密钥生成器，指定为AES算法,不区分大小写
...
//        String[] keys={"","xI0l6U6LXgXBhe3fUve4InWBO5ziGIrrzLNJYVmVXZ7XtfN1PtbwTMRMpqVgytpHe/N/rdzaFzCe1rIxChxu+2f91Mw++naXn8VgRyDqNsQ="};
...
//        }
        String solt2 = new String(Base64.encode("矿大CUMT".getBytes()));
