        ...
        try{
            ...
            if (fileType != null) {
                ...
                if (booIsType) {
                    ...
                    System.out.println("FileUtil.java 48：" + path);
                    String fileSrc="";
                    if (isRandomName) {
...
//                    }
                    ...
                    //fileSrc=req.getScheme()+"://"+req.getServerName()+":"+req.getServerPort()+req.getContextPath()+"/images/"+initialName;
                    System.out.println("FileUtil.java 53：图片上传成功:"+path+initialName);
                    return path+initialName;
                }
            }
        }catch (Exception e){
            e.printStackTrace();
